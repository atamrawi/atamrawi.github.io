...
layout: default
---
Ahmed Tamrawi is a Software Security researcher and instructor, and a full-stack developer. He has extensive experience in program analysis to detect novel and sophisticated algoithmic complexity and side channel attacks in Java applications and malware in Android applications. Ahmed has experience working on two high profile DARPA projects: APAC and STAC. He served on the ISU team as an analyst for DARPA’s Automated Program Analysis for Cybersecurity (APAC) program. Currently, he is serving on the EnSoft team on DARPA’s Space/Time Analysis for Cybersecurity (STAC) program.
